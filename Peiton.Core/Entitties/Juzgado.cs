...
public class Juzgado
{
	...
	/* public virtual ICollection<ControlCuentaGeneral> ControlesCuentasGeneralesJuzgadoArchivado { get; } = new List<ControlCuentaGeneral>(); */
	/* public virtual ICollection<ControlCuentaGeneral> ControlesCuentasGeneralesJuzgadoPresentada { get; } = new List<ControlCuentaGeneral>(); */
